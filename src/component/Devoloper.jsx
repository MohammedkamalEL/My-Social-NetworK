      ...
      <div className="bg-gray-50">
        <div className="container max-w-5xl mx-auto p-4 my-8">
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="bg-linear-to-r from-blue-600 to-indigo-700 animate-gradient text-white p-6 md:p-10">
              <div className="flex flex-col md:flex-row items-center">
                ...
                <div className="md:w-3/4 text-center md:text-left md:pl-8">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3">
                    <div className="flex items-center bg-red bg-opacity-20 rounded-full px-4 py-1">
                      <svg
                      ...
                      <span className="text-sm ">
                        mohamed.kamal.web.dev@gmail.com
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-2">
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                      ...
                      React, Remix, and TypeScript, focused on crafting
                      scalable, high-performance web applications. I specialize
                      in creating seamless user experiences through clean,
                      efficient, and responsive UI design. With a strong
                      foundation in modern web technologies, I enjoy solving
                      complex problems and building interactive digital
                      solutions. I'm always eager to learn, innovate, and
                  ...
                  <div className="mb-8">
                    ...
                    <div className="relative pl-6 border-l-2 border-blue-200">
                      ...
                      <p className="text-blue-600 font-medium text-sm mb-2">
                        November 2023 - December 2023 (1 year 2 months)
                      </p>
                      ...
                      <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                        <li>
                          Built and optimized web applications with React.js,
                          Remix, and TypeScript to enhance performance
                        </li>
                        <li>
                          Designed and implemented responsive UI components
                          using Tailwind CSS for cross-device compatibility
                        </li>
                        <li>
                      ...
                      <p className="text-sm text-gray-600">
                        React.js | Remix | TypeScript | JavaScript | Tailwind
                        CSS | API Integrations | UI/UX Development | Performance
                        Optimization
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="p-4 border-l-4 border-blue-600 bg-blue-50 mt-3 rounded-r">
                      <h3 className="text-lg font-semibold text-gray-800">
            ...
            <div className="bg-gray-50 p-4 text-center text-sm text-gray-500 border-t border-gray-200">
              <p> © 2025 Mohammed Kamal Eldien </p>
            </div>
          </div>
        </div>
      </div>
